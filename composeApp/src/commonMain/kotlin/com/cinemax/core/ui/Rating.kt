...
import cinemax.composeapp.generated.resources.ic_star
import cinemax.composeapp.generated.resources.not_rated
import cinemax.composeapp.generated.resources.rating
        ...
        Row(
            ...
            Text(
                text = if (rating == RatingNotRatedValue) {
                    stringResource(Res.string.not_rated)
                } else {
                    rating.toString()
                },
