...
import cinemax.composeapp.generated.resources.movies
import cinemax.composeapp.generated.resources.no_movie_results
import cinemax.composeapp.generated.resources.no_search_results
import cinemax.composeapp.generated.resources.no_tv_show_results
import cinemax.composeapp.generated.resources.see_all
import cinemax.composeapp.generated.resources.tv_shows
import com.cinemax.core.designsystem.component.CinemaxCenteredBox
import com.cinemax.core.designsystem.component.CinemaxCircularProgressIndicator
...
import com.cinemax.core.ui.util.error
import com.cinemax.core.ui.util.isEmpty
import com.cinemax.core.ui.util.isError
import com.cinemax.core.ui.util.isFinished
import com.cinemax.core.ui.util.isLoading
import com.cinemax.core.ui.util.isNotEmpty
...
fun MoviesAndTvShowsContainer(
    ...
    Column(modifier = modifier) {
        ContainerTitleWithButton(titleResource = titleResource, onSeeAllClick = onSeeAllClick)
...
fun MoviesContainer(
    ...
    emptyContent: @Composable LazyItemScope.() -> Unit = {
        CinemaxMessage(
            ...
            message = stringResource(Res.string.no_movie_results),
            painter = painterResource(Res.drawable.no_search_results)
        )
    },
...
fun TvShowsContainer(
    ...
    emptyContent: @Composable LazyItemScope.() -> Unit = {
        CinemaxMessage(
            modifier = Modifier.fillParentMaxSize(),
            message = stringResource(Res.string.no_tv_show_results),
            painter = painterResource(Res.drawable.no_search_results)
        )
    },
    loadingContent: @Composable LazyItemScope.() -> Unit = { CinemaxCircularProgressIndicator() },
